...
const RenderingDeviceContext := preload("res://addons/aerobeat-vendor-gdgs/runtime/render/gaussian_rendering_device_context.gd")
...
const SHADER_PATH_PROJECTION := "res://addons/aerobeat-vendor-gdgs/runtime/render/shaders/compute/gsplat_projection.glsl"
const SHADER_PATH_RADIX_UPSWEEP := "res://addons/aerobeat-vendor-gdgs/runtime/render/shaders/compute/radix_sort_upsweep.glsl"
const SHADER_PATH_RADIX_SPINE := "res://addons/aerobeat-vendor-gdgs/runtime/render/shaders/compute/radix_sort_spine.glsl"
const SHADER_PATH_RADIX_DOWNSWEEP := "res://addons/aerobeat-vendor-gdgs/runtime/render/shaders/compute/radix_sort_downsweep.glsl"
const SHADER_PATH_BOUNDARIES := "res://addons/aerobeat-vendor-gdgs/runtime/render/shaders/compute/gsplat_boundaries.glsl"
const SHADER_PATH_RENDER := "res://addons/aerobeat-vendor-gdgs/runtime/render/shaders/compute/gsplat_render.glsl"
